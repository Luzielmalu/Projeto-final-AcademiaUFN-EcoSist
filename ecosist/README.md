...
[(https://img.shields.io/maven-metadata/v?color=blue&metadataUrl=https://repo.example.com/maven2/com/example/artifact/maven-metadata.xml)](https://img.shields.io/maven-central/v/:groupId/:artifactId
)
