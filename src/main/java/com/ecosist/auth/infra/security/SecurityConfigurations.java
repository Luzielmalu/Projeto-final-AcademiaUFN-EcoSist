    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
    	return  httpSecurity.cors().and()
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.PUT, "/agendamento").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/agendamento/{id}/{campo}").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/agendamento/{id}").hasRole("ADMIN")
